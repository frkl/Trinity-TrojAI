...
def extract_bo_features(model,tokenizer,dataset):
    ...
    nh=512
    nlayers=4
    checkpoint='linear_512_200_v2.pt'
    ...
    #print(len(datas))
    #assert len(datas)==4;
    #assert len(datas[-1]['input_ids'])==12
...
def extract_fvs_(id=0,root='data/round8-train-dataset/models'):
    ...
    examples_dirpath='selected_data_36.json';
...
if __name__ == "__main__":
    ...
    for i,id in enumerate(model_ids):
        ...
        data.save('data_r8_surrogate7.pt');
